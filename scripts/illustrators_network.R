...
main <- function(i, a, o, y) {
  print("preprocessing input files")
  illus.list <- read_tsv(i, col_names = c("illustrator", "volume"))
  illus.list <- preprocess(illus.list, "illustrators")
  authors.list <- read_tsv(a, col_names = c("author", "volume"))
  authors.list <- preprocess(authors.list, "authors")
  print("creating edge list")
  el <- edge.list(authors.list, illus.list, period = y, filepath = o)
  ...
  write.csv(data.frame(general = graph.density(net, loops = FALSE), illustrators = graph.density(net.i, loops = FALSE), authors = graph.density(net.a, loops = FALSE)), paste0(o, "/",paste(y, "density.csv", sep = "_")))
  print("calculating metrics")
  metrics <- measure(net, TRUE, "general", y, filepath = o)
  print("drawing visualizations")
  visualize(net <- net, "general", y, ".png", filepath = o)
  print("detecting communities")
  net.c <- com.detect(net, content = "general", period = y, filepath = o)
  print("generating tables for the-cluster-to-node contributions calculation")
  weight_communities_table(net.c, y, filepath = o)
  print("visualizing communities")
  visualize(net.c, content = "communities", y, ".png", filepath = o)
  print("visualizing every community and calculating centrality metrics in every community")
  for(i in unique(V(net.c)$community)){
    net.r <- select.com(net.c, i)
    visualize(net.r, content = paste0("single_community", i), y, filename = ".png", filepath = o)
    metrics.r <- measure(net.r, TRUE, content = paste0("single_community", i), y, filepath = o)
 }
  print("calculating centrality metrics in illustrators network")
  metrics.i <- measure(net.i, FALSE, "illustrators", y, filepath = o)
  print("visualizing illustrators network")
  visualize(net.i, content = "general", y, paste("illustrators", ".png", sep = ""), filepath = o)
  print("detecting communities of illustrators")
  net.i.c <- com.detect(net.i, "illustrators", y, filepath = o) 
  print("visualizing communities of illustrators")
  visualize(net = net.i.c, content = "communities", y, paste("illustrators", ".png", sep = ""), filepath = o)
  ...
  for(i in unique(V(net.i.c)$community)){
    ...
    visualize(net.i.r, content = "single community", y, filename = paste("illustrators", paste(i, sep = ""), ".png", sep = "_"), filepath = o)
  }
  print("calculating centrality metrics in authors network")
  metrics.a <- measure(net.a, FALSE, "authors", y, filepath = o)
  print("visualizing authors network")
  visualize(net.a, content = "general", y, paste("authors", ".png", sep = ""), filepath = o)
  print("detecting communities of authors")
  net.a.c <- com.detect(net.a, "authors", y, filepath = o)
  print("visualizing communities of authors")
  visualize(net = net.a.c, content = "communities", y, paste("authors", ".png", sep = ""), filepath = o)
  ...
  for(i in unique(V(net.a.c)$community)){
    ...
    visualize(net.a.r, content = "single community", y, filename = paste("authors", paste(i, sep = ""), ".png", sep = "_"), filepath = o)
  }
  }
